...
(function() {
	...
	if (window.location.href.indexOf("forumdisplay.php") > -1) {
		...
		$(menuButtons).prepend("<a href=\"usercp.php?action=api\" class=\"button\" title=\"Applications you have authorized to access the API on your behalf.\"><i class=\"fas fa-key fa-lg\" style=\"margin-right: 4px; margin-left: 4px;\"></i><span>Authorized Apps</span></a> <a href=\"usercp.php?action=apideveloper\" class=\"button\" title=\"View your API developer clients and keys here.\"><i class=\"fas fa-code fa-lg\" style=\"margin-right: 4px; margin-left: 4px;\"></i><span>Developer</span></a> <a href=\"usercp.php?action=apinew\" class=\"button\" title=\"Are you a developer making a new app? Start here.\"><i class=\"fas fa-plus-circle fa-lg\" style=\"margin-right: 4px; margin-left: 4px;\"></i><span>New App</span></a></div>");
	}
